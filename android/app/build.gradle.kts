...
android {
    namespace = "com.literatureradar.app"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.literatureradar.app"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "0.1.0"
...
dependencies {
    ...
    // themes.xml 的 Theme.Material3.DayNight.NoActionBar 来自 View 侧 Material，非 Compose BOM
